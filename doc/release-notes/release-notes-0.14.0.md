...
- #7562 `1eef038` Bump transaction version default to 2 (BTCHPdrak)
...
- #8608 `7e9ab95` Install manpages via make install, also add some autogenerated manpages (nomnomBTCHP)
...
- #8568 `078900d` new var `DIST_CONTRIB` adds useful things for packagers from contrib (nomnomBTCHP)
...
- #9206 `e662d28` Make test constant consistent with consensus.h (BTCHPdrak)
