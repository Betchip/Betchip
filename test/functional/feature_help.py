...
"""Verify that starting betchip with -h works as expected."""

from test_framework.test_framework import BetchipTestFramework
from test_framework.util import assert_equal

class HelpTest(BetchipTestFramework):
    ...
    def run_test(self):
        self.log.info("Start betchip with -h for help text")
        ...
        self.log.info("Start betchip with -version for version information")
        ...
        self.log.info("Start betchipd with -fakearg to make sure it does not start")
