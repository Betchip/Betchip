...
{
    const char* pszTimestamp = "The Times 26/May/2018 Alan Bean, 4th Person to Walk on the Moon, Dies at 86";
...
public:
    CMainParams() {
        ...
        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000001018ac4de4b2e09578");
        ...
        genesis = CreateGenesisBlock(1527389602, 2550396556, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000000004f3331a6959193bcd8efcfd05e365415c0f1f91f1d44ed881a6b1f6b"));
        assert(genesis.hashMerkleRoot == uint256S("0x985194b30345a67ee0affd995c20a59e5f07e474e27f6c455989566f16645fa9"));
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1527414802, 1710602683, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000000c58600e2c85c27651ff5e8400955c005f2e20e96180f025fd834a8d6"));
        assert(genesis.hashMerkleRoot == uint256S("0x985194b30345a67ee0affd995c20a59e5f07e474e27f6c455989566f16645fa9"));
        ...
        checkpointData = {
            {
                {0, uint256S("00000000c58600e2c85c27651ff5e8400955c005f2e20e96180f025fd834a8d6")},
            }
        };
