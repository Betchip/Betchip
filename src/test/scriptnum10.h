...
#ifndef BETCHIP_TEST_SCRIPTNUM10_H
#define BETCHIP_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Betchip Core 0.10.0, for cross-comparison.
 */
public:
