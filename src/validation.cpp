...
#if defined(NDEBUG)
# error "Betchip cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Betchip Signed Message:\n";
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    if(nHeight >= 0 && nHeight <= 20285)
        nSubsidy = 50 * COIN;
    else if(nHeight > 20285 && nHeight < 21966)
        nSubsidy = 5355 * COIN;
    else if(nHeight > 48631 && nHeight < 48873)
        nSubsidy = 50000 * COIN;
    else
        nSubsidy = 46 * COIN;
