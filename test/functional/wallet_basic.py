...
class WalletTest(BetchipTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 BTP from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 BTP in block rewards plus fees, but
        ...
        # Send 10 BTP with subtract fee from amount
        ...
        # Sendmany 10 BTP with subtract fee from amount
