...
### Build and sign Betchip Core for Linux, Windows, and OS X:
...
Build output expected:
  ...
  4. OS X unsigned installer and dist tarball (`betchip-${VERSION}-osx-unsigned.dmg`, `betchip-${VERSION}-osx64.tar.gz`)
...
Add other gitian builders keys to your gpg keyring, and/or refresh keys.
    ...
    gpg --import betchip/contrib/gitian-keys/*.pgp
    gpg --refresh-keys
...
Codesigner only: Sign the osx binary:
    ...
    transfer betchip-osx-unsigned.tar.gz to osx for signing
...
- Update betchip.org version
  ...
  - First, check to see if the Betchip.org maintainers have prepared a
    release: https://github.com/betchip-dot-org/betchip.org/labels/Releases
  ...
  - If they have not prepared a release, follow the Betchip.org release
    instructions: https://github.com/betchip-dot-org/betchip.org#release-notes
