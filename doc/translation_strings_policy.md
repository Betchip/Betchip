...
This document provides guidelines for internationalization of the Betchip Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `betchip_en.ts` remains unchanged.
