...
#ifndef BETCHIP_QT_BETCHIPUNITS_H
#define BETCHIP_QT_BETCHIPUNITS_H
...
/** Betchip unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BetchipUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BetchipUnits(QObject *parent);

    /** Betchip units.
      @note Source: https://en.betchip.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTP,
...
typedef BetchipUnits::Unit BetchipUnit;

#endif // BETCHIP_QT_BETCHIPUNITS_H
