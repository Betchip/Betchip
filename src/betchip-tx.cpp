...
static void SetupBetchipTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " betchip-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  betchip-tx [options] <hex-tx> [commands]  Update hex-encoded betchip transaction\n" +
            "or:     betchip-tx [options] -create [commands]   Create hex-encoded betchip transaction\n" +
            "\n";
