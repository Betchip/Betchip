...
#ifndef BETCHIP_INTERFACES_NODE_H
#define BETCHIP_INTERFACES_NODE_H
...
//! Top-level interface for a betchip node (betchipd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BETCHIP_INTERFACES_NODE_H
