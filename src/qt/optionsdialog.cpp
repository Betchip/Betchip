    ...
    mapper(0)
{
    ...
    ui->betchipAtStartup->setToolTip(ui->betchipAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->betchipAtStartup->setText(ui->betchipAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openBetchipConfButton->setToolTip(ui->openBetchipConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new BetchipUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->betchipAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBetchipConfButton_clicked()
{
