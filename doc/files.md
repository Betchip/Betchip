...
* betchip.conf: contains configuration settings for betchipd or betchip-qt
* betchipd.pid: stores the process id of betchipd while running
...
* debug.log: contains debug information and general logging generated by betchipd or betchip-qt
