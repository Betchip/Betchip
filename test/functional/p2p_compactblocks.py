...
# TestP2PConn: A peer we use to send messages to betchipd, and store responses.
...
class CompactBlocksTest(BetchipTestFramework):
    ...
    # This test actually causes betchipd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that betchipd requests compact blocks when we announce new blocks
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # betchipd will not send blocktxn responses for blocks whose height is
