...
By default, betchipd will dump mempool on shutdown and
...
class MempoolPersistTest(BetchipTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give betchipd a second to reload the mempool
        ...
        self.log.debug("Prevent betchipd from writing mempool.dat to disk. Verify that `savemempool` fails")
